...
******************************************************************************/
function agendaTelefone(){
	$item[0] = array("nome" => "Joana da Silva", "Telefone" =>"3131-3030", "Celular" => "9988-7788" );
	$item[1] = array("nome" => "Manoel Souza", "Telefones" => "3166-3070", "Celular" => "9955-7755");	
	$item[2] = array("nome" => "Silvio Santos", "Telefone" => "4531-4530", "Celular" => "9945-4588");
	return $item;
}
echo "<pre>";
print_r (agendaTelefone());
echo "<pre>";
